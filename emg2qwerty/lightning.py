...
class GRUCTCModule(pl.LightningModule):
    """CTC model with a GRU encoder (no temporal downsampling).

    This satisfies the project requirement to use at least one recurrent
    architecture while keeping the architecture simple to train and modify.
    """
    ...
    def _step(self, phase: str, batch: dict[str, torch.Tensor]) -> torch.Tensor:
        ...
        # No temporal downsampling in the GRU path
